...
----
ifeval::["{lang}" == "java"]
include::{java_path}/composite/PlaylistComponent.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/composite/Song.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/composite/Playlist.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/composite/MusicPlayer.java[]
endif::[]

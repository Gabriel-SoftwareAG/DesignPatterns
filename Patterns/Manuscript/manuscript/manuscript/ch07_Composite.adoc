...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/PlaylistComponent.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/PlaylistComponent.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/Song.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/Song.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/Playlist.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/Playlist.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/MusicPlayer.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/MusicPlayer.ts[lines=3..]
endif::[]
----

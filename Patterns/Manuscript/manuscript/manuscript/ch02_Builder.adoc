...
----
ifeval::["{lang}" == "java"]
include::{java_path}/builder/Builder.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/builder/ConcreteBuilder.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/builder/Product.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/builder/Director.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/builder/Client.java[]
endif::[]

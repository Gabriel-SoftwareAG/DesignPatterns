...
----
ifeval::["{lang}" == "java"]
include::{java_path}/adapter/ElectricalOutlet.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/adapter/ElectronicDevice.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/adapter/ElectronicDevice.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/adapter/UniversalAdapter.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/adapter/Traveler.java[]
endif::[]

...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/Post.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/Post.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/Post.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/Blog.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/Blog.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/Blog.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/BlogPlatform.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/BlogPlatform.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/BlogPlatform.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/Iterator.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/Iterator.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/Iterator.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/PostIterator.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/PostIterator.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/PostIterator.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/iterator/User.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/iterator/User.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/iterator/User.ts[lines=3..]
endif::[]
----

The `User` class demonstrates how a user interacts with the blog platform. It creates a `BlogPlatform` instance, adds posts, and iterates through the posts using an iterator.

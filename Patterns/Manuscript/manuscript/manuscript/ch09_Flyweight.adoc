...
----
ifeval::["{lang}" == "java"]
include::{java_path}/flyweight/Balloon.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/Balloon.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/flyweight/ConcreteBalloon.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/ConcreteBalloon.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/flyweight/BalloonFactory.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/BalloonFactory.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/flyweight/PartyDecorator.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/PartyDecorator.py[lines=3..]
endif::[]
----

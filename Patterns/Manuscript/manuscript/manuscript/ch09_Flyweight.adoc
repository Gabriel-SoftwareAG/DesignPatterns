...
ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/Book.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/flyweight/Book.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/ConcreteBook.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/flyweight/ConcreteBook.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/Library.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/flyweight/Library.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/flyweight/Client.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/flyweight/Client.cs[lines=3..]
endif::[]

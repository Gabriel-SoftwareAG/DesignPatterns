...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/ConcreteProductA.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/factorymethod/ConcreteProductA.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/ConcreteProductB.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/factorymethod/ConcreteProductB.py[lines=3..]
endif::[]
----

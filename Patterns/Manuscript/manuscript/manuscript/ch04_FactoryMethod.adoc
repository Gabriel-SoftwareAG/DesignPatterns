...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/Product.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/ConcreteProductA.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/factorymethod/ConcreteProductA.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/ConcreteProductB.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/factorymethod/ConcreteProductB.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/FoodStall.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/PizzaStall.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/IceCreamStall.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/factorymethod/ParkVisitor.java[]
endif::[]

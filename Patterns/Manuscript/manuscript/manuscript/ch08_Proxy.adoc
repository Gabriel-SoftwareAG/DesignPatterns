...
[discrete%breakable]
=== Class Diagram
image::ProxyPatternClassDiagram.png[title="The Proxy Class Diagram", align=center]
...
[discrete%breakable]
=== Sequence Diagram
image::ProxyPatternSequenceDiagram.png[title="The Proxy Sequence Diagram", align=center]
...
ifeval::["{lang}" == "python"]
include::{python_path}/proxy/LegalService.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/LegalService.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/LegalService.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/proxy/ProxyLegalService.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/ProxyLegalService.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/ProxyLegalService.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/proxy/RealLegalService.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/RealLegalService.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/RealLegalService.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "python"]
include::{python_path}/proxy/Client.py[lines=3..]
endif::[]

ifeval::["{lang}" == "csharp"]
include::{csharp_path}/adapter/Client.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/adapter/Client.ts[lines=3..]
endif::[]
----

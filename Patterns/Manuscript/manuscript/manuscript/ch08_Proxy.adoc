...
----
ifeval::["{lang}" == "java"]
include::{java_path}/proxy/LegalService.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/proxy/ProxyLegalService.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/proxy/RealLegalService.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/proxy/Client.java[]
endif::[]

...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/ConcretePrototype1.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/prototype/ConcretePrototype1.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/ConcretePrototype2.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/prototype/ConcretePrototype2.py[lines=3..]
endif::[]
----

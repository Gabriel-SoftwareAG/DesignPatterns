...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/Prototype.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/ConcretePrototype1.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/prototype/ConcretePrototype1.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/ConcretePrototype2.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/prototype/ConcretePrototype2.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/prototype/Client.java[]
endif::[]

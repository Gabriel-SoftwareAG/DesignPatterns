...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AbstractFoodStallFactory.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AdventureLandFactory.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/FantasyLandFactory.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AbstractProductA.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/abstractfactory/AbstractProductA.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AbstractProductB.java[]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/abstractfactory/AbstractProductB.py[]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/TropicalIceCream.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/ExoticPizza.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/MagicalIceCream.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/EnchantedPizza.java[]
endif::[]
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/ParkVisitor.java[]
endif::[]

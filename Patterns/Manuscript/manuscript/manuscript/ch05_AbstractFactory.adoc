...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AbstractProductA.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/abstractfactory/AbstractProductA.py[lines=3..]
endif::[]
----
...
----
ifeval::["{lang}" == "java"]
include::{java_path}/abstractfactory/AbstractProductB.java[lines=3..]
endif::[]

ifeval::["{lang}" == "python"]
include::{python_path}/abstractfactory/AbstractProductB.py[lines=3..]
endif::[]
----

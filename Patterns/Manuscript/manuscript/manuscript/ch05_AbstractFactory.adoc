...
=== Class Diagram
image::AbstractFactoryPatternClassDiagram.png[title="The Builder Class Diagram"]
...
=== Sequence Diagram
image::AbstractFactoryPatternSequenceDiagram.png[title="The Builder Class Diagram"]

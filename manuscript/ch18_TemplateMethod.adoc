...
[discrete%breakable]
=== Class Diagram
image::TemplateMethodPatternClassDiagram.png[title="The Template Method Class Diagram", align=center, scaledwidth=70%]
...
[discrete%breakable]
=== Sequence Diagram
image::TemplateMethodPatternSequenceDiagram.png[title="The Template Method Sequence Diagram", align=center, scaledwidth=70%]

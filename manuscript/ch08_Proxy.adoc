...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/proxy/LegalService.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/proxy/ProxyLegalService.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/proxy/RealLegalService.cs[lines=3..]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/proxy/Client.cs[lines=3..]
endif::[]

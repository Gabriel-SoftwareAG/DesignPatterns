...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/strategy/IStudent.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/strategy/MathStudent.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/strategy/ScienceStudent.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/strategy/Teacher.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/strategy/ObserverClient.cs[]
endif::[]

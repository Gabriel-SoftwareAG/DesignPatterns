...
include::{typescript_path}/observer/Student.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "typescript"]
include::{typescript_path}/observer/MathStudent.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "typescript"]
include::{typescript_path}/observer/ScienceStudent.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "typescript"]
include::{typescript_path}/observer/Teacher.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "typescript"]
include::{typescript_path}/observer/Client.ts[lines=3..]
endif::[]
----

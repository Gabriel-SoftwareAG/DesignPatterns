...
ifeval::["{lang}" == "python"]
include::{python_path}/observer/Student.py[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/observer/MathStudent.py[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/observer/ScienceStudent.py[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/observer/Teacher.py[lines=3..]
endif::[]
...
ifeval::["{lang}" == "python"]
include::{python_path}/observer/Client.py[lines=3..]
endif::[]

...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/builder/Client.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/builder/Client.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/builder/ConcreteBuilder.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/builder/ConcreteBuilder.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/builder/Product.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/builder/Product.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/builder/Director.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/builder/Director.ts[lines=3..]
endif::[]
----

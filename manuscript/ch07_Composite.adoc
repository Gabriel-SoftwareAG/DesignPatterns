...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/composite/PlaylistComponent.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/composite/PlaylistComponent.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/composite/Song.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/composite/Song.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/composite/Playlist.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/composite/Playlist.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/composite/MusicPlayer.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/composite/MusicPlayer.ts[lines=3..]
endif::[]
----

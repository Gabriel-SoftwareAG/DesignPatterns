...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/IState.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/GreenState.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/YellowState.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/RedState.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/TrafficLight.cs[]
endif::[]
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/TrafficSystem.cs[]
endif::[]

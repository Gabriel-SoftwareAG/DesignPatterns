...
[discrete%breakable]
=== Class Diagram
image::StatePatternClassDiagram.png[title="The State Class Diagram", align=center, scaledwidth=50%]
...
[discrete%breakable]
=== Sequence Diagram
image::StatePatternSequenceDiagram.png[title="The State Sequence Diagram", align=center, scaledwidth=90%]

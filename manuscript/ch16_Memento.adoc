...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/GameState.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/memento/GameState.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/Player.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/memento/Player.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/SaveManager.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/memento/SaveManager.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/memento/Client.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/memento/Client.ts[lines=3..]
endif::[]
----

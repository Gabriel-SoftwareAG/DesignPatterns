...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/singleton/Singleton.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/singleton/Library.ts[lines=3..]
endif::[]
----
...
ifeval::["{lang}" == "csharp"]
include::{csharp_path}/singleton/Client.cs[lines=3..]
endif::[]

ifeval::["{lang}" == "typescript"]
include::{typescript_path}/singleton/Client.ts[lines=3..]
endif::[]
----
